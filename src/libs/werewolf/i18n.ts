...
const M = {
    ...
    en: {
        ...
        joinAlreadyJoined: "️ You are already in the lobby!",
        ...
        leaveNotIn: "️ You are not in this lobby.",
        ...
        seerAlreadyDone: "️ You already investigated someone tonight.",
        ...
        doctorAlreadySaved: "️ You already chose a protection target tonight.",
    ...
    id: {
        ...
        joinAlreadyJoined: "️ Kamu sudah bergabung di lobby ini!",
        ...
        leaveNotIn: "️ Kamu tidak ada di lobby ini.",
        ...
        seerAlreadyDone: "️ Kamu sudah melakukan pengecekan malam ini.",
        seerSelf: "Tidak bisa mengecek diri sendiri!",
        seerResultWolf: (name: string) =>
            `*Hasil Pengecekan:*\n${name} adalah...\n\n*SERIGALA!* Dia berbahaya!`,
        seerResultSafe: (name: string) =>
            `*Hasil Pengecekan:*\n${name} adalah...\n\n*Warga Desa.* Dia aman.`,
        doctorAlreadySaved: "️ Kamu sudah memilih target penyelamatan malam ini.",
